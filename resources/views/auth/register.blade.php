    ...
    <div class="card">
        <div class="card-body register-card-body">
            ...
            <form action=" {{ route("register") }} " method="post">
                ...
                @enderror
                <div class="input-group mb-3">
                    <input name="first_name" type="text" class="form-control @error("first_name") border-danger @enderror" placeholder="{{ __('Имя') }}" value="{{old('first_name')}}">
                    <div class="input-group-append">
                ...
                @enderror
                <div class="input-group mb-3">
                    <input name="last_name" type="text" class="form-control @error("last_name") border-danger @enderror" placeholder="{{ __('Фамилия') }}" value="{{old('last_name')}}">
                    <div class="input-group-append">
                ...
                @enderror
                <div class="input-group mb-3">
                    <input name="password_confirmation" type="password" class="form-control @error("password_confirmation") border-danger @enderror" placeholder="{{ __('Подтверждение пароля') }}">
                    <div class="input-group-append">
